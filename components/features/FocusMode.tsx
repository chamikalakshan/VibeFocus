        ...
        >
            ...
            <div className="flex flex-col items-center gap-8 max-w-md w-full">
                <div className="text-center space-y-2">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-br from-white to-zinc-400 bg-clip-text text-transparent">
                        {task.title}
                    </h1>
                </div>
                ...
                <div
                    ...
                    className={cn(
                        ...
                        !isActive && "cursor-pointer hover:shadow-[0_0_30px_rgba(239,68,68,0.2)]"
                    )}
                ...
                >
                    {/* SVG Progress Ring */}
                    <svg className="absolute inset-0 w-full h-full -rotate-90 drop-shadow-[0_0_15px_rgba(239,68,68,0.3)] pointer-events-none">
                        {/* Background track */}
                        <circle
                            cx="150"
                            cy="150"
                ...
                <div className="flex items-center gap-6 mt-4">
                    <Button
                        ...
                        className={cn(
                            ...
                            isActive
                                ...
                                : "bg-red-600 hover:bg-red-700 shadow-red-500/30 border-red-400/20"
                        )}
                    ...
                    <Button
                        size="lg"
                        variant="outline"
                        className="h-16 px-8 rounded-full border-2 border-energy-green/50 text-energy-green hover:bg-energy-green hover:text-black font-bold transition-all"
